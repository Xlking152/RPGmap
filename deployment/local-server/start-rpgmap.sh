...
mkdir -p "$ROOT/world/uploads" "$ROOT/world/backups" "$ROOT/maps"
export RPGMAP_PUBLIC_DIR="$ROOT/app"
export RPGMAP_WORLD_DIR="$ROOT/world"
export RPGMAP_MAPS_DIR="$ROOT/maps"
URL="http://127.0.0.1:${PORT:-30000}"
echo "RPGmap World Data: $RPGMAP_WORLD_DIR"
echo "RPGmap Map Library: $RPGMAP_MAPS_DIR"
