...
test('combatant view prefers Token Runtime / Synthetic Actor data', () => {
...
test('combatant view retains Character fallback for legacy callers', () => {
  ...
  assert.equal(view.name, '旧角色');
  assert.equal(view.avatar, 'legacy.png');
