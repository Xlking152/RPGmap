...
export function renderPublicProfileEditor({ actor, statusDefinitions = [], pending = false, feedback = '', preview = false } = {}) {
  const profile = normalizeActorPublicProfile(actor?.publicProfile);
