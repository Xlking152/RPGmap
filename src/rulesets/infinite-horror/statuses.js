export const INFINITE_HORROR_STATUS_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({
    id: 'status-strengthened',
    name: '强化', label: '强化',
    description: '安全跟踪状态；具体数值由当前规则与主持人判定。',
    icon: 'sparkles', color: '#3f7f63', category: 'buff',
    scopes: Object.freeze(['actor', 'token']), maxStacks: 99,
    changes: Object.freeze([]), capabilities: Object.freeze({}), builtIn: true,
  }),
  Object.freeze({
    id: 'status-weakened',
    name: '虚弱', label: '虚弱',
    description: '安全跟踪状态；不自动虚构属性减值。',
    icon: 'activity', color: '#8d5965', category: 'debuff',
    scopes: Object.freeze(['actor', 'token']), maxStacks: 99,
    changes: Object.freeze([]), capabilities: Object.freeze({}), builtIn: true,
  }),
  Object.freeze({
    id: 'status-poisoned',
    name: '中毒', label: '中毒',
    description: '记录中毒层数和持续时间；不自动扣除生命。',
    icon: 'skull', color: '#587a3d', category: 'debuff',
    scopes: Object.freeze(['actor', 'token']), maxStacks: 99,
    changes: Object.freeze([]), capabilities: Object.freeze({}),
    defaultDuration: Object.freeze({ unit: 'turns', value: 3 }), builtIn: true,
  }),
  Object.freeze({
    id: 'status-burning',
    name: '燃烧', label: '燃烧',
    description: '记录燃烧层数和持续时间；不自动造成伤害。',
    icon: 'flame', color: '#b75d32', category: 'debuff',
    scopes: Object.freeze(['actor', 'token']), maxStacks: 99,
    changes: Object.freeze([]), capabilities: Object.freeze({}),
    defaultDuration: Object.freeze({ unit: 'turns', value: 3 }), builtIn: true,
  }),
  Object.freeze({
    id: 'status-bleeding',
    name: '流血', label: '流血',
    description: '记录流血层数和持续时间；不自动造成伤害。',
    icon: 'droplet', color: '#9c3c42', category: 'debuff',
    scopes: Object.freeze(['actor', 'token']), maxStacks: 99,
    changes: Object.freeze([]), capabilities: Object.freeze({}),
    defaultDuration: Object.freeze({ unit: 'turns', value: 3 }), builtIn: true,
  }),
  Object.freeze({
    id: 'status-blinded',
    name: '目盲', label: '目盲',
    description: '精确侦测降为模糊侦测，不改变模糊范围。',
    icon: 'eye-off', color: '#555f68', category: 'debuff',
    scopes: Object.freeze(['actor', 'token']), maxStacks: 1,
    changes: Object.freeze([]), capabilities: Object.freeze({ visionPrecision: 'vague' }),
    defaultDuration: Object.freeze({ unit: 'rounds', value: 1 }), builtIn: true,
  }),
]);
